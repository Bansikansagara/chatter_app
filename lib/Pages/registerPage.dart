...
class RegisterPage extends State<Register> {
  ...
  void insertData(){
    var url1 = "https://unbought-milk.000webhostapp.com/flutter_project_morning/api/register/register_insert.php";
  ...
  Future viewMobileNoData() async {
    var url = "https://unbought-milk.000webhostapp.com/flutter_project_morning/api/register/register_unique_mobileno_view.php";
